#!/usr/bin/env bash
#
# Configure HashKey Chain: create .env from env.template and set EXT_IP.
#
# Usage: ./configure.sh
#
set -euo pipefail
...
HOST_DATADIR="$(env_get HOST_DATADIR "${HOME}/hashkey-op-geth-data")"
HOST_OP_NODE_DATADIR="$(env_get HOST_OP_NODE_DATADIR "${HOME}/hashkey-op-node-data")"
