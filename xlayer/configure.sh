#!/usr/bin/env bash
#
# Configure X Layer (op-geth) deployment: create .env from env.template and set public IP.
#
# Usage: ./configure.sh
...
echo ""
echo "Next:"
echo "  edit .env — set L1_RPC_URL, L1_BEACON_URL, ZKEVM_L1_RPC_URL"
echo "  ./create-jwt.sh"
echo "  ./init-database.sh      # from scratch only"
echo "  docker compose build    # cdk-erigon image"
